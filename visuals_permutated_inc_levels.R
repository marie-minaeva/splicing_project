...
data_full_1 = read.csv("Data/output_non_sQTL.csv")
data_full_1 %>% select(intersect(colnames(data_full), colnames(data_full_1))) -> data_full_1
data_full = data_full[!flag_outliers(data_full$LENGTH) & data_full$LENGTH >= 15,]
data_full_1 = data_full_1[!flag_outliers(data_full_1$LENGTH) & data_full_1$LENGTH >= 15,]
