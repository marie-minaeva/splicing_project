...
data = data_full[data_full$der_allele_hl == "higher", ]
data2 = data_full[data_full$der_allele_hl == "lower", ]
...
ggplot() + geom_density(data=data[data$LENGTH!=0,], aes(LENGTH, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[data2$LENGTH!=0,], aes(LENGTH, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data[!flag_outliers(data$HYDROPATHICITY),], aes(HYDROPATHICITY, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$HYDROPATHICITY),], aes(HYDROPATHICITY, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data[!flag_outliers(data$ASN../data$LENGTH *100),], aes(ASN../LENGTH *100, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$ASN../data2$LENGTH *100),], aes(ASN../LENGTH * 100, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data[!flag_outliers(data$CYS../data$LENGTH *100),], aes(CYS../LENGTH *100, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$CYS../data2$LENGTH *100),], aes(CYS../LENGTH * 100, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data, aes(CYS../LENGTH *100, fill="higher_in"), alpha = 0.2) + geom_density(data=data2, aes(CYS../LENGTH * 100, fill="non higher_in"), alpha = 0.2)
...
ggplot() + geom_density(data=data[!flag_outliers(data$MIN),], aes(MIN, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$MIN),], aes(MIN, fill="non higher_in"), alpha = 0.2) 
ggplot() + geom_density(data=data[!flag_outliers(data$Q1),], aes(Q1, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$Q1),], aes(Q1, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data[!flag_outliers(data$Q2),], aes(Q2, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$Q2),], aes(Q2, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data[!flag_outliers(data$Q3),], aes(Q3, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$Q3),], aes(Q3, fill="non higher_in"), alpha = 0.2) 
ggplot() + geom_density(data=data[!flag_outliers(data$MAX),], aes(MAX, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$MAX),], aes(MAX, fill="non higher_in"), alpha = 0.2)


ggplot() + geom_density(data=data[!flag_outliers(data$MIN_pLLDT),], aes(MIN_pLLDT, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$MIN_pLLDT),], aes(MIN_pLLDT, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data[!flag_outliers(data$Q1_pLLDT),], aes(Q1_pLLDT, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$Q1_pLLDT),], aes(Q1_pLLDT, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data[!flag_outliers(data$Q2_pLLDT),], aes(Q2_pLLDT, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$Q2_pLLDT),], aes(Q2_pLLDT, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data[!flag_outliers(data$Q3_pLLDT),], aes(Q3_pLLDT, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$Q3_pLLDT),], aes(Q3_pLLDT, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data[!flag_outliers(data$MAX_pLLDT),], aes(MAX_pLLDT, fill="higher_in"), alpha = 0.2) + geom_density(data=data2[!flag_outliers(data2$MAX_pLLDT),], aes(MAX_pLLDT, fill="non higher_in"), alpha = 0.2)




ggplot() + geom_density(data=data, aes(HELIX, fill="higher_in"), alpha = 0.2) + geom_density(data=data2, aes(HELIX, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data, aes(SHEET, fill="higher_in"), alpha = 0.2) + geom_density(data=data2, aes(SHEET, fill="non higher_in"), alpha = 0.2)
ggplot() + geom_density(data=data, aes(TURN, fill="higher_in"), alpha = 0.2) + geom_density(data=data2, aes(TURN, fill="non higher_in"), alpha = 0.2)
...
ggsave("statistical_summary_without_correction_derived_groups.png", path = "Data/visuals/", height = 5.11, width = 7.92,device='png', dpi=700)
to_draw$trait = factor(to_draw$trait)
...
ggplot(to_draw[to_draw$test_type == "fisher", ], aes(x = trait, y = log(as.numeric(statistics)), alpha = alpha)) +
        ...
        theme(axis.line.x = element_line(arrow = grid::arrow(length = unit(0.3, "cm"),ends = "both")),
              axis.title.x = element_text(angle = 0)) + gtex_v8_figure_theme()
ggsave("statistical_summary_fisher_derived_groups.png", path = "Data/visuals/", height = 5.11, width = 7.92,device='png', dpi=700)

line1 = replicate(length(pval), 0.0)
col = c( '4', '5', '6', 'light blue', 'orange', '3')
ggplot(to_draw[to_draw$test_type == "ks", ], aes(x = trait, y = as.numeric(statistics), alpha = alpha)) +
        geom_point(size = 4, color=col) +
        geom_errorbar(aes(ymax = as.numeric(conf_top), ymin = as.numeric(conf_low)), color=col) +  
        ylab("Enrichment in lower inclusion exons                                                                  Enrichment in higher inclusion exons\n m1-m2") + 
        coord_flip() + geom_hline(yintercept = line1, color="red") + 
        theme(axis.line.x = element_line(arrow = grid::arrow(length = unit(0.3, "cm"),ends = "both")),
              axis.title.x = element_text(angle = 0)) + gtex_v8_figure_theme()
#ggsave("statistical_summary_with_correction_der_all.png", path = "Data/visuals/", height = 5.11, width = 7.92,device='png', dpi=700)
ggsave("statistical_summary_ks_derived_groups.png", path = "Data/visuals/", height = 5.11, width = 7.92,device='png', dpi=700)
